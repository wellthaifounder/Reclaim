...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      categorization_rules: {
        Row: {
          ...
          id: string
          is_medical: boolean
          match_operator: Database["public"]["Enums"]["rule_name_operator"]
    ...
    Functions: {
      ...
      preview_categorization_rule: {
        Args: {
          ...
          p_match_operator?: Database["public"]["Enums"]["rule_name_operator"]
    ...
    Enums: {
      ...
      rule_name_operator: "is_exactly" | "starts_with" | "contains"
      transfer_kind:
        | "card_payment"
        | "internal"
        | "hsa_distribution"
